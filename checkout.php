<?php 
    ...
    $current_user_sql = "SELECT * FROM users WHERE u_id = $login_user_id";
...
<body class="bg-body-tertiary" onload="getData()">
  <div class="container">
    <main>
      ...
      <div class="row g-5">
        ...
        <div class="col-md-7 col-lg-8">
          ...
          <form class="needs-validation" id="checkout_form" method="post"  action="./process_checkout.php" novalidate>
            <input type="hidden" name="amount" id="cart_total_input">
            <input type="hidden" name="productinfo" id="cart_products_input">
    ...
    <script>
      ...
      function getData(){
        ...
        req.addEventListener('load', function(){
          ...
          document.getElementById("cart_total_input").value = cart_total;
          document.getElementById("cart_products_input").value = product_names.join(", ");
        })
      }
